...
let torontoData = "https://raw.githubusercontent.com/jillibus/Making_Earthquakes/data/torontoRoutes.json";
...
d3.json(torontoData).then(function(data) {
    ...
    L.geoJSON(data, {
        onEachFeature: function(feature, layer) {
            layer.bindPopup("<h2>Airline code: " + feature.properties.airline_id + "</hd><hr> <h3>Destination: " + feature.properties.dst + "</h3>");         
            },
            style: myStyle
    }).addTo(map);
});
